...
describe('resource active', () => {
  test('list', async () => {
    const responsePromise = client.blockchain.providers.bids.active.list(
  ...
  test('list: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      client.blockchain.providers.bids.active.list('0x1234567890abcdef1234567890abcdef12345678', {
